...
class Autocomplete extends Component {
  ...
  displayLabel() {
    if (this.props.label && (this.state.focused || this.state.inputValue)) {
      return <Label style={[Style.TextInputLabelStyle1, { zIndex: 20 }]}>{this.props.label}</Label>
    }
  }
